...
public interface ICpBondCode extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type daishin.cputil.CPE_BOND_TYPE
   */

  @DISPID(3) //= 0x3. The runtime will prefer the VTID if present
  @VTID(9)
  daishin.cputil.CPE_BOND_TYPE type();
   ...
   * </p>
   * @return  Returns a value of type daishin.cputil.CPE_BOND_REMAIN
   */

  @DISPID(4) //= 0x4. The runtime will prefer the VTID if present
  @VTID(10)
  daishin.cputil.CPE_BOND_REMAIN remain();
   ...
   * </p>
   * @return  Returns a value of type daishin.cputil.CPE_BOND_ISSUE
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(11)
  daishin.cputil.CPE_BOND_ISSUE issue();
   ...
   * </p>
   * @return  Returns a value of type daishin.cputil.CPE_BOND_INTEREST
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(12)
  daishin.cputil.CPE_BOND_INTEREST interest();
   ...
   * </p>
   * @return  Returns a value of type daishin.cputil.CPE_BOND_RETAIL
   */

  @DISPID(9) //= 0x9. The runtime will prefer the VTID if present
  @VTID(15)
  daishin.cputil.CPE_BOND_RETAIL retail();
